...
public class ProductRemoteGatewayTest65 {
	
	@Test
	public void testRemoteCreateAccount() {
		Map<String, String> requestData = new HashMap<String, String>();
		String localGatewayURL = "http://10.110.176.65:8080/gateway/V1";//http://10.110.176.65:8080/gateway/V1";
		requestData.put("serviceID", "createAccount");
		requestData.put("productCode", "1000000002");
		requestData.put("notifyURL", "http://10.110.176.65:8080/gateway/callback");
	...
	public void testRemoteActiveAccount() {
		Map<String, String> requestData = new HashMap<String, String>();
		String localGatewayURL = "http://10.110.176.65:8080/gateway/V1";
...
//		requestData.put("productCode", "1000000002");
	...
	public void testRemoteTransactionQuery() {
		Map<String, String> requestData = new HashMap<String, String>();
		String localGatewayURL = "http://10.110.176.65:8080/gateway/V1";//"http://10.110.126.159:8080/gateway/transactionQuery";
