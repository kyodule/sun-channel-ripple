    ...
    extends BufferedBlockCipher
{
     ...
     * @exception org.ripple.bouncycastle.crypto.DataLengthException if there isn't enough space in out.
     ...
     * @return the number of output bytes copied to out.
     * @exception org.ripple.bouncycastle.crypto.DataLengthException if there is insufficient space in out for
     * the output.
     * @exception IllegalStateException if the underlying cipher is not
     * initialised.
     * @exception org.ripple.bouncycastle.crypto.InvalidCipherTextException if cipher text decrypts wrongly (in
