...
//            ECFieldElement.F2m.checkFieldElements(a.x, b.x);
        ...
        /* (non-Javadoc)
         * @see org.ripple.bouncycastle.math.ec.ECPoint#add(org.ripple.bouncycastle.math.ec.ECPoint)
         */
        public ECPoint add(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see org.ripple.bouncycastle.math.ec.ECPoint#subtract(org.ripple.bouncycastle.math.ec.ECPoint)
         */
        public ECPoint subtract(ECPoint b)
        {
            checkPoints(this, b);
