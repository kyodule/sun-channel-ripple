    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers
{
        ...
        extends DSASigner
    {
        public detDSA()
        {
            super(new SHA1Digest(), new org.ripple.bouncycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA1Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public detDSA224()
        {
            super(new SHA224Digest(), new org.ripple.bouncycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA224Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public detDSA256()
        {
            super(new SHA256Digest(), new org.ripple.bouncycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA256Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public detDSA384()
        {
            super(new SHA384Digest(), new org.ripple.bouncycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA384Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public detDSA512()
        {
            super(new SHA512Digest(), new org.ripple.bouncycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA512Digest())));
        }
    }
